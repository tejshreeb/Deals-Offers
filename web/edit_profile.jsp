<%-- 
    ...
    Created on : Apr 13, 2017, 2:39:25 AM
    Author     : DELL
--%>
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
                                            ...
                                            <input type="text" name="display_name" id="display_name" class="form-control input-lg" placeholder="Username" tabindex="4">
			...
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-6"><input type="submit" value="Save Changes" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
				<!--<div class="col-xs-12 col-md-6"><a href="#" class="btn btn-success btn-block btn-lg">Save Changes</a></div>-->
			</div>
		</form>
	</div>
</div>
